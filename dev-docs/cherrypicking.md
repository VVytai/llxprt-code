...
- **Restore Command** - LLxprt uses `/continue` instead of `/restore` for session restoration. The command architecture differs significantly. Commits moving restore logic (e.g., `b27cf0b0a8dd`) should be skipped.
